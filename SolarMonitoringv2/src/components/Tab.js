...
const TypeOfDeviceTab = ({ showState, selectedThing, updateThing }) => {
  ...
  const items = [
    {
      key: '1',
      label: 'Power meter',
      content: <DataTableFull selectedThing={selectedThing} updateThing={updateThing}/>, // Replace this with the component you want to render
    },
    {
      key: '2',
