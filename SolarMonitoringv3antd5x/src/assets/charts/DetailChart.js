...
const Chart1 = ({ dateString, unitoftime, inverter_id }) => {
    console.log("from chart right: " + dateString);
    ...
    useEffect(() => {
        if (dateString) { // Check if dateString is not null
            console.log(`${process.env.REACT_APP_DJANGO_URL}/api2/my-api/inverterdatachartright/`);
            fetch(`${process.env.REACT_APP_DJANGO_URL}/api2/my-api/inverterdatachartright/`, {
                method: 'PUT',
                headers: {
