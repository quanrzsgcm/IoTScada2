...
const MyChart2v = ({ rawData }) => {
    ...
    const transformedData = {
        options: {
            ...
            colors: ['#34eb7a', '#66DA26', '#546E7A', '#E91E63', '#FF9800'],
            legend: {
                show: true,
                position: 'top',
        ...
        series: [
            {
                ...
                data: rawData.map(item => ({
                    x: item.timestamp,
                    y: parseFloat(item.voltage)  // Assuming 'power' is a string, convert it to a floating-point number
                  })),
